...
#import "MNetAdViewReuseRepository.h"
#import "MNetTestManager.h"
#import "MNDemoConstants.h"

@interface MNetAdViewReuseRepositoryTests : MNetTestManager

@end

@implementation MNetAdViewReuseRepositoryTests
...
- (void)testRepositoryViewPush{
    ...
    MNetAdView *adView = (MNetAdView *)[[MNetAdViewReuseRepository getSharedInstance] getAdViewForCreativeId:DEMO_MN_AD_UNIT_320x50];
...
- (void)testRepositoryViewFetchFail{
    ...
    MNetAdView *adView = (MNetAdView *)[[MNetAdViewReuseRepository getSharedInstance] getAdViewForCreativeId:@""];
    XCTAssertNil(adView);
}
