    ...
    dispatch_once(&onceToken, ^{
      adsListArr = @[
          ...
          @{
              ...
              @"rowContents" : @[
                  @{@"title" : @"Rewarded Video Sample", @"name" : ENUM_VAL(VIDEO_REWARDED)},
                  @{@"title" : @"DFP Mediation Rewarded Video", @"name" : ENUM_VAL(DFP_REWARDED)}
              ]
          },
          @{
              @"sectionTitle" : @"Header Bidding",
              @"rowContents" : @[
                  @{@"title" : @"DFP Sample Ad", @"name" : ENUM_VAL(DFP_HB)},
                  @{@"title" : @"MoPub Sample Ad", @"name" : ENUM_VAL(MOPUB_HB)}
              ]
          },
          @{
              @"sectionTitle" : @"Header Bidding Interstitial",
              @"rowContents" : @[
                  @{@"title" : @"DFP Sample Ad", @"name" : ENUM_VAL(DFP_INTERSTITIAL_HB)},
